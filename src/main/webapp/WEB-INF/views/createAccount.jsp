            ...
            <div class="authorization">
                <div class="authorization_form">
                    <form method="post" action="createAccount">
                        ...
                        <c:if test="${!empty passwordErrorMessage}">
                            <div class="error">${passwordErrorMessage}</div>
                        </c:if>
                        <input type="password" class="input" id="password" name="password" required> <label class="label">パスワード（確認用）</label>
                        <c:if test="${!empty checkPasswordErrorMessage}">
                            <div class="error">${checkPasswordErrorMessage}</div>
                        </c:if>
