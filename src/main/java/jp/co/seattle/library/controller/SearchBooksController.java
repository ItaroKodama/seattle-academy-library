...
public class SearchBooksController {
    ...
    public String searchBooks(Locale locale,
        ...
        if (booksService.searchBooks(isTitleSearchPartial, titleSearchWord, isAuthorSearchPartial, authorSearchWord,
            ...
            model.addAttribute("bookList", booksService.searchBooks(isTitleSearchPartial, titleSearchWord,
